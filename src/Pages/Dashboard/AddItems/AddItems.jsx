                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex  gap-6">
                        ...
                        <div className="w-full">
                            ...
                            <select {...register('category' , {required: true})} defaultValue="Select a category" className="select w-full" >
                    ...
                    <button className="btn w-40 p-4 font-semibold text-lg" >
